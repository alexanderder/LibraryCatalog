...
public class BookBean implements Serializable {
    ...
    private List<PersonEntity> allAuthorsList;
    ...
    public List<PersonEntity> getAuthors() {
        if (this.allAuthorsList == null) {
            this.allAuthorsList = personService.findAllPersonEntities();
        }
